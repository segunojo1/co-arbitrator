import { FileText, Scale, Search, ZoomIn } from "lucide-react";
...
const SmartMatcher = () => {
  return (
    <div className="min-h-screen w-full flex flex-row font-sans bg-white">
          ...
          <div className="max-w-2xl flex flex-col justify-between h-full mt-10">
            ...
            <div>
              ...
              <div className="w-32 h-32 bg-gray-50 rounded-2xl flex flex-col items-center justify-center border border-gray-100 cursor-pointer hover:bg-gray-100 transition-colors">
                ...
                <span className="text-xs text-gray-400 font-medium">20 MB</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-[40%] bg-[#020618] relative overflow-hidden flex flex-col justify-end px-16">
        ...
        <div className="relative z-10 ">
          ...
          <button className="bg-white text-[#020618] px-5 py-[10px] rounded-lg text-[14px]/[20px] font-medium hover:bg-gray-100 transition-colors">
            Get Started
          </button>
