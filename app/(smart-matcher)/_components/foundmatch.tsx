...
const FoundMatch = ({ response }: any) => {
  return (
    <div className="flex flex-col gap-11">
      <div className="p-6 rounded-[28px] flex items-end">
        <div className="w-36 h-36 rounded-[28px] bg-[#D9D9D9] mr-4" />

        <div className="mr-9">
          <h1 className="text-[32px]/[54px] -tracking-[.5px] font-instrument-serif">
            Sunita Shekhawat&apos;s
          </h1>
          <p className="text-[14px]/[25px] font-medium text-[#0A0A0AB2] -tracking-[.7px]">
            Arbitrator
          </p>
          <h2 className="text-[#0A0A0AB2] text-[15px]/[25px] font-bold -tracking-[.7px] py-2">
            Institution
          </h2>
      ...
      <div className="bg-[#8E51FF33] rounded-3xl p-5 max-w-4xl flex items-start gap-2">
